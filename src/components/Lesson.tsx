        ...
        <Link to={`/event/lesson/${props.slug}`} className='group'>
            ...
            ${isLessonActive?"bg-green-500 text-white group-hover:border-green-white":"group-hover:border-green-700"}`}>
                <header className="flex items-center justify-between">
                    ...
                    <span className={`font-xs font-bold rounded ${!isLessonActive?"text-green-300 border-green-300":"bg-green-500 text-white border-white"} border  text-center py-[0.125rem] px-1 `}>
